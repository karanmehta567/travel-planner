...
export default function Navbar({session}:{session:Session|null}){
    return (
        <nav className="bg-white shadow-md py-4 border-b border-gray-200">
            <div className="container mx-auto justify-between items-center px-6 lg:px-8 flex">
                  ...
                  <div className="flex items-center space-x-4">
                {
                    session?(
                        <>
                    <Link href={'/trips'} className="text-slate-900 hover:text-sky-300">
                        My Trips
                    </Link>
                    <Link href={'/globe'} className="text-slate-900 hover:text-sky-400">
                    Globe
                    </Link>
